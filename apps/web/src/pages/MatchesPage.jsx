  ...
  useEffect(() => {
    async function loadPageData() {
      try {
        ...
        const mappedMatches = matchesData.map(mapMatchToCardModel);
          ...
          <section style={styles.profileCard}>
            ...
            <div style={styles.profileDetails}>
              ...
              <div style={styles.profileItem}>
                ...
                <span style={styles.profileValue}>{profile.user_id}</span>
              </div>

              <div style={styles.profileItem}>
                <span style={styles.profileLabel}>Account ID</span>
                <span style={styles.profileValue}>{profile.account_id}</span>
              </div>
            </div>
          </section>
        )}
